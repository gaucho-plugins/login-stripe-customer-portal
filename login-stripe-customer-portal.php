...
// Ensure Stripe SDK is included if not already loaded
...
class Plugin {
    ...
    public function sanitize_redirect_url($input) {
        return !empty($input) ? esc_url_raw($input) : '';
    }
            ...
            <form method="post" action="options.php">
                ...
                <table class="form-table">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="url" name="lscp_stripe_redirect_url" value="<?php echo esc_url(get_option('lscp_stripe_redirect_url', $customer_portal_url)); ?>" />
